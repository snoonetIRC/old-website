...
class BlogpostsControllerTest < ActionController::TestCase
  ...
  test "should create blogpost" do
    assert_difference('Blogpost.count') do
      post :create, blogpost: { body: @blogpost.body, excerpt: @blogpost.excerpt, timestamp: @blogpost.timestamp, title: @blogpost.title }
    end
  ...
  test "should update blogpost" do
    put :update, id: @blogpost, blogpost: { body: @blogpost.body, excerpt: @blogpost.excerpt, timestamp: @blogpost.timestamp, title: @blogpost.title }
    assert_redirected_to blogpost_path(assigns(:blogpost))
  end
